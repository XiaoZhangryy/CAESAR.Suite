...
This vignette introduces the CAESAR workflow for the analysis of MOB ST spatial transcriptomics dataset. In this vignette, the workflow of CAESAR consists of four steps
...
```{r}
githubURL <- "https://github.com/XiaoZhangryy/CAESAR/blob/master/vignettes_data/MOB_ST.rda?raw=true"
download.file(githubURL, "MOB_ST.rda", mode='wb')
MOB_ST <- readRDS("./MOB_ST.RDS")

print(MOB_ST)

githubURL <- "https://github.com/XiaoZhangryy/CAESAR/blob/master/vignettes_data/MOB_scRNA.rda?raw=true"
download.file(githubURL, "MOB_scRNA.rda", mode='wb')
MOB_scRNA <- readRDS("./MOB_scRNA.RDS")
