...
```{r}
githubURL <- "https://github.com/XiaoZhangryy/CAESAR/blob/main/vignettes_data/MOB_ST.rda?raw=true"
download.file(githubURL, "MOB_ST.rda", mode='wb')

print(MOB_ST)

githubURL <- "https://github.com/XiaoZhangryy/CAESAR/blob/main/vignettes_data/MOB_scRNA.rda?raw=true"
