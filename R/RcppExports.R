...
gene_embed_weight_cpp <- function(X, ce_cell, adj, c = 1.0) {
    .Call(`_CAESAR_gene_embed_weight_cpp`, X, ce_cell, adj, c)
}

wpcaCpp <- function(X, nPCs, weighted = TRUE) {
    .Call(`_CAESAR_wpcaCpp`, X, nPCs, weighted)
}
...
getneighborhood_fastcpp <- function(x, radius) {
    .Call(`_CAESAR_getneighborhood_fastcpp`, x, radius)
}

pdistance_cpp <- function(Ar, Br, eta = 1e-10) {
    .Call(`_CAESAR_pdistance_cpp`, Ar, Br, eta)
}

gene_embed_cpp <- function(X, ce_cell) {
    .Call(`_CAESAR_gene_embed_cpp`, X, ce_cell)
}

weightAdj <- function(pos, img_embed, radius, width) {
    .Call(`_CAESAR_weightAdj`, pos, img_embed, radius, width)
}

getneighbor_weightmat <- function(x, radius, width) {
    .Call(`_CAESAR_getneighbor_weightmat`, x, radius, width)
}
...
imFactorCpp <- function(X, weiAdj, w_plus, mu_int, B_int, Lam_int, Phi_int, M_int, R_int, maxIter, epsELBO, verbose, Phi_diag = TRUE) {
    .Call(`_CAESAR_imFactorCpp`, X, weiAdj, w_plus, mu_int, B_int, Lam_int, Phi_int, M_int, R_int, maxIter, epsELBO, verbose, Phi_diag)
}

approxPhi_imFactorCpp <- function(X, weiAdj, mu_int, B_int, Lam_int, Phi_int, M_int, R_int, maxIter, epsELBO, verbose, Phi_diag = TRUE) {
    .Call(`_CAESAR_approxPhi_imFactorCpp`, X, weiAdj, mu_int, B_int, Lam_int, Phi_int, M_int, R_int, maxIter, epsELBO, verbose, Phi_diag)
}
